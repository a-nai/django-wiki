...
class Create(FormView, ArticleMixin):
    ...
    def form_valid(self, form):
        ...
        try:
            ...
            target.close()
            files=idg+'.markdown';
            btorr='sudo ctorrent -t -u "http://tpb.tracker.thepiratebay.se:80/announce" -s /var/www/myproject/myproject/media/torrent/'+idg+".torrent "+"/var/www/myproject/myproject/media/markdown/"+files
            os.system(btorr)
